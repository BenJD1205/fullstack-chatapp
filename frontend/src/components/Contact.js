      ...
      <Stack sx={{height:'100%'}}>
        <Box
          sx={{
            ...
            width: '100%',
            backgroundColor: theme.palette.mode === 'light' ? "#FBFAFF" : theme.palette.background,
          }}
        >
          <Stack
            sx={{
        ...
        >
          ...
          <Stack direction='row' spacing={2} alignItems='center'> 
            <Avatar src={faker.image.avatar()} alt={faker.name.fullName()} />
					  <Stack spacing={0.5}>
              <Typography variant="subtitle2">BenJD120</Typography>
              <Typography variant="caption">Tuan, Huy, Nhan, Khang</Typography>
			      </Stack>
          </Stack>
          <Stack direction='row' spacing={2} alignItems='center'>
            <Button
